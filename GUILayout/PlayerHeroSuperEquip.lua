...
function PlayerHeroSuperEquip.main()
    ...
    -- 行会名字
    local CheckBox = GUI:CheckBox_Create(SuperEquipUI, "CheckBox", 25, attachH-25, "res/public/1900000550.png", "res/public/1900000551.png")
    local Text_CheckBox = GUI:Text_Create(CheckBox, "Text_CheckBox", 35, 2, 16, "#41CA44", "时装外显示")
