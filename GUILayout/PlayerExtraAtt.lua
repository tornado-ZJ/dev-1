...
function PlayerExtraAtt.main()
    ...
    PlayerExtraAtt.ListView = ListView

    PlayerExtraAtt.RefreshAttr(true)
    
    SL:RegisterLUAEvent("LUA_EVENT_REFBASEATTR", "PlayerExtraAttr", PlayerExtraAtt.RefreshAttr)
end

function PlayerExtraAtt.RefreshAttr(isJump)
    local data = SL:GetRoleData()
    local List = PlayerExtraAtt.ListView
    ...
    if not item_1 then
        item_1 = GUI:Layout_Create(List, "item_1", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_1, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
    ...
    if not item_2 then
        item_2 = GUI:Layout_Create(List, "item_2", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_2, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 准确
    local hit = SL:GetMetaValue("M.HIT")
    local item_3 = GUI:getChildByName(List, "item_3")
    if not item_3 then
        item_3 = GUI:Layout_Create(List, "item_3", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_3, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 闪避
    local spd = SL:GetMetaValue("M.M_SPEED")
    local item_4 = GUI:getChildByName(List, "item_4")
    if not item_4 then
        item_4 = GUI:Layout_Create(List, "item_4", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_4, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 攻击
    local minDC = SL:GetMetaValue("M.MIN_ATK")
    local maxDC = SL:GetMetaValue("M.MAX_ATK")
    local item_5 = GUI:getChildByName(List, "item_5")
    if not item_5 then
        item_5 = GUI:Layout_Create(List, "item_5", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_5, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔法
    local minMC = SL:GetMetaValue("M.MIN_MAG")
    local maxMC = SL:GetMetaValue("M.MAX_MAG")
    local item_6 = GUI:getChildByName(List, "item_6")
    if not item_6 then
        item_6 = GUI:Layout_Create(List, "item_6", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_6, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 道术
    local minSC = SL:GetMetaValue("M.MIN_DAO")
    local maxSC = SL:GetMetaValue("M.MAX_DAO")
    local item_7 = GUI:getChildByName(List, "item_7")
    if not item_7 then
        item_7 = GUI:Layout_Create(List, "item_7", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_7, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 防御
    local minAC = SL:GetMetaValue("M.MIN_DEF")
    local maxAC = SL:GetMetaValue("M.MAX_DEF")
    local item_8 = GUI:getChildByName(List, "item_8")
    if not item_8 then
        item_8 = GUI:Layout_Create(List, "item_8", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_8, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔防
    local minMAC = SL:GetMetaValue("M.MIN_MDF")
    local maxMAC = SL:GetMetaValue("M.MAX_MDF")
    local item_9 = GUI:getChildByName(List, "item_9")
    if not item_9 then
        item_9 = GUI:Layout_Create(List, "item_9", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_9, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 背包负重
    local minBW = SL:GetMetaValue("M.BW")
    local maxBW = SL:GetMetaValue("M.MAXBW")
    local item_10 = GUI:getChildByName(List, "item_10")
    if not item_10 then
        item_10 = GUI:Layout_Create(List, "item_10", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_10, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 装备负重
    local minWW = SL:GetMetaValue("M.WW")
    local maxWW = SL:GetMetaValue("M.MAXWW")
    local item_11 = GUI:getChildByName(List, "item_11")
    if not item_11 then
        item_11 = GUI:Layout_Create(List, "item_11", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_11, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 手持负重
    local minHW = SL:GetMetaValue("M.HW")
    local maxHW = SL:GetMetaValue("M.MAXHW")
    local item_12 = GUI:getChildByName(List, "item_12")
    if not item_12 then
        item_12 = GUI:Layout_Create(List, "item_12", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_12, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 掉落概率
    local dp = SL:GetMetaValue("M.DROP")
    local item_13 = GUI:getChildByName(List, "item_13")
    if not item_13 then
        item_13 = GUI:Layout_Create(List, "item_13", 0, 0, PlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_13, "num_bg", 175, 15, PlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
