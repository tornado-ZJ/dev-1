...
function Recharge.createCell(PMainUI)
    local cell = GUI:Layout_Create(PMainUI, "product_cell", 0, 0, 115, 50, true)
    ...
    local Text_name = GUI:Text_Create(PMainUI, "Text_name", 57.5, 35, 16, "#FFFF00", "")
    GUI:setAnchorPoint(Text_name, {x=0.5, y=0.5})

    local Text_ratio = GUI:Text_Create(PMainUI, "Text_ratio", 57.5, 15, 12, "#FFFF00", "")
