TradePlayerHeroExtraAtt = {}

function TradePlayerHeroExtraAtt.main()
    local parent  = GUI:Attach_Parent()
    local attachW = 348
    local attachH = 478
    TradePlayerHeroExtraAtt.attachW = attachW

    local _ResPath = "res/private/player_main_layer_ui/player_main_layer_ui_mobile/"
    TradePlayerHeroExtraAtt.ResPath = _ResPath
    ...
    local GuildFlag = GUI:Image_Create(ExtraAttrUI, "GuildFlag", 606, 407, "res/private/guild_ui/guild_icon.png")
    GUI:setAnchorPoint(GuildFlag, 0.5, 0.5)

    -- ListView
    local ListView = GUI:ListView_Create(ExtraAttrUI, "ListView", 5, 5, attachW - 10, attachH - 10, 1)
    TradePlayerHeroExtraAtt.ListView = ListView
    TradePlayerHeroExtraAtt.RefreshAttr(true)
end

function TradePlayerHeroExtraAtt.RefreshAttr(isJump)
    local data = SL:GetHeroData()
    local List = TradePlayerHeroExtraAtt.ListView

    -- 生命值
    local curHP = SL:GetMetaValue("T.H.HP")
    local maxHP = SL:GetMetaValue("T.H.MAXHP")
    local item_1 = GUI:getChildByName(List, "item_1")
    if not item_1 then
        item_1 = GUI:Layout_Create(List, "item_1", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_1, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
    ...
    -- 魔法值
    local curMP = SL:GetMetaValue("T.H.MP")
    local maxMP = SL:GetMetaValue("T.H.MAXMP")
    local item_2 = GUI:getChildByName(List, "item_2")
    if not item_2 then
        item_2 = GUI:Layout_Create(List, "item_2", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_2, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 准确
    local hit = SL:GetMetaValue("T.H.HIT")
    local item_3 = GUI:getChildByName(List, "item_3")
    if not item_3 then
        item_3 = GUI:Layout_Create(List, "item_3", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_3, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 闪避
    local spd = SL:GetMetaValue("T.H.M_SPEED")
    local item_4 = GUI:getChildByName(List, "item_4")
    if not item_4 then
        item_4 = GUI:Layout_Create(List, "item_4", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_4, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 攻击
    local minDC = SL:GetMetaValue("T.H.MIN_ATK")
    local maxDC = SL:GetMetaValue("T.H.MAX_ATK")
    local item_5 = GUI:getChildByName(List, "item_5")
    if not item_5 then
        item_5 = GUI:Layout_Create(List, "item_5", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_5, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔法
    local minMC = SL:GetMetaValue("T.H.MIN_MAG")
    local maxMC = SL:GetMetaValue("T.H.MAX_MAG")
    local item_6 = GUI:getChildByName(List, "item_6")
    if not item_6 then
        item_6 = GUI:Layout_Create(List, "item_6", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_6, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 道术
    local minSC = SL:GetMetaValue("T.H.MIN_DAO")
    local maxSC = SL:GetMetaValue("T.H.MAX_DAO")
    local item_7 = GUI:getChildByName(List, "item_7")
    if not item_7 then
        item_7 = GUI:Layout_Create(List, "item_7", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_7, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 防御
    local minAC = SL:GetMetaValue("T.H.MIN_DEF")
    local maxAC = SL:GetMetaValue("T.H.MAX_DEF")
    local item_8 = GUI:getChildByName(List, "item_8")
    if not item_8 then
        item_8 = GUI:Layout_Create(List, "item_8", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_8, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔防
    local minMAC = SL:GetMetaValue("T.H.MIN_MDF")
    local maxMAC = SL:GetMetaValue("T.H.MAX_MDF")
    local item_9 = GUI:getChildByName(List, "item_9")
    if not item_9 then
        item_9 = GUI:Layout_Create(List, "item_9", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_9, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 背包负重
    local minBW = SL:GetMetaValue("T.H.BW")
    local maxBW = SL:GetMetaValue("T.H.MAXBW")
    local item_10 = GUI:getChildByName(List, "item_10")
    if not item_10 then
        item_10 = GUI:Layout_Create(List, "item_10", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_10, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 装备负重
    local minWW = SL:GetMetaValue("T.H.WW")
    local maxWW = SL:GetMetaValue("T.H.MAXWW")
    local item_11 = GUI:getChildByName(List, "item_11")
    if not item_11 then
        item_11 = GUI:Layout_Create(List, "item_11", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_11, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 手持负重
    local minHW = SL:GetMetaValue("T.H.HW")
    local maxHW = SL:GetMetaValue("T.H.MAXHW")
    local item_12 = GUI:getChildByName(List, "item_12")
    if not item_12 then
        item_12 = GUI:Layout_Create(List, "item_12", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_12, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 掉落概率
    local dp = SL:GetMetaValue("T.H.DROP")
    local item_13 = GUI:getChildByName(List, "item_13")
    if not item_13 then
        item_13 = GUI:Layout_Create(List, "item_13", 0, 0, TradePlayerHeroExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_13, "num_bg", 175, 15, TradePlayerHeroExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
