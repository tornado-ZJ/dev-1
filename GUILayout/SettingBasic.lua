...
function SettingBasic.main()
    ...
    local labelZoom = GUI:Text_Create(FrameList, "labelZoom", 30, 0, 16, "#ffffff", string.format("%s(%.1f倍)", content, perVal))
    local sliderZoom = GUI:Slider_Create(FrameList, "sliderZoom", 30, 0, barimg, pbarimg, nimg)
