...
function LookPlayerHeroMain.main( skipPage )
    ...
    GUI:addOnClickEvent(Page3, function()
        LookPlayerHeroMain.PageTo(3)
    end)
    posY = posY - distance
    local PageText3 = GUI:Text_Create(Page3, "PageText", 13, 60, 18, "#ffffff", "神\n装")
    GUI:setAnchorPoint(PageText3, 0.5, 0.5)

    LookPlayerHeroMain.PageTo(skipPage or 1)
end

function LookPlayerHeroMain.PageTo(index)
    LookPlayerHeroMain.index = index
end