...
function TradePlayerExtraAtt.main()
    local parent  = GUI:Attach_Parent()
    local attachW = 348
    local attachH = 478
    TradePlayerExtraAtt.attachW = attachW

    local _ResPath = "res/private/player_main_layer_ui/player_main_layer_ui_mobile/"
    TradePlayerExtraAtt.ResPath = _ResPath
    ...
    TradePlayerExtraAtt.ListView = ListView

    TradePlayerExtraAtt.RefreshAttr(true)
end

function TradePlayerExtraAtt.RefreshAttr(isJump)
    local data = SL:GetRoleData()
    local List = TradePlayerExtraAtt.ListView

    -- 生命值
    local curHP = SL:GetMetaValue("T.M.HP")
    local maxHP = SL:GetMetaValue("T.M.MAXHP")
    local item_1 = GUI:getChildByName(List, "item_1")
    if not item_1 then
        item_1 = GUI:Layout_Create(List, "item_1", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_1, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
    ...
    -- 魔法值
    local curMP = SL:GetMetaValue("T.M.MP")
    local maxMP = SL:GetMetaValue("T.M.MAXMP")
    local item_2 = GUI:getChildByName(List, "item_2")
    if not item_2 then
        item_2 = GUI:Layout_Create(List, "item_2", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_2, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 准确
    local hit = SL:GetMetaValue("T.M.HIT")
    local item_3 = GUI:getChildByName(List, "item_3")
    if not item_3 then
        item_3 = GUI:Layout_Create(List, "item_3", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_3, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 闪避
    local spd = SL:GetMetaValue("T.M.M_SPEED")
    local item_4 = GUI:getChildByName(List, "item_4")
    if not item_4 then
        item_4 = GUI:Layout_Create(List, "item_4", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_4, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 攻击
    local minDC = SL:GetMetaValue("T.M.MIN_ATK")
    local maxDC = SL:GetMetaValue("T.M.MAX_ATK")
    local item_5 = GUI:getChildByName(List, "item_5")
    if not item_5 then
        item_5 = GUI:Layout_Create(List, "item_5", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_5, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔法
    local minMC = SL:GetMetaValue("T.M.MIN_MAG")
    local maxMC = SL:GetMetaValue("T.M.MAX_MAG")
    local item_6 = GUI:getChildByName(List, "item_6")
    if not item_6 then
        item_6 = GUI:Layout_Create(List, "item_6", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_6, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 道术
    local minSC = SL:GetMetaValue("T.M.MIN_DAO")
    local maxSC = SL:GetMetaValue("T.M.MAX_DAO")
    local item_7 = GUI:getChildByName(List, "item_7")
    if not item_7 then
        item_7 = GUI:Layout_Create(List, "item_7", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_7, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 防御
    local minAC = SL:GetMetaValue("T.M.MIN_DEF")
    local maxAC = SL:GetMetaValue("T.M.MAX_DEF")
    local item_8 = GUI:getChildByName(List, "item_8")
    if not item_8 then
        item_8 = GUI:Layout_Create(List, "item_8", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_8, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 魔防
    local minMAC = SL:GetMetaValue("T.M.MIN_MDF")
    local maxMAC = SL:GetMetaValue("T.M.MAX_MDF")
    local item_9 = GUI:getChildByName(List, "item_9")
    if not item_9 then
        item_9 = GUI:Layout_Create(List, "item_9", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_9, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 背包负重
    local minBW = SL:GetMetaValue("T.M.BW")
    local maxBW = SL:GetMetaValue("T.M.MAXBW")
    local item_10 = GUI:getChildByName(List, "item_10")
    if not item_10 then
        item_10 = GUI:Layout_Create(List, "item_10", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_10, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 装备负重
    local minWW = SL:GetMetaValue("T.M.WW")
    local maxWW = SL:GetMetaValue("T.M.MAXWW")
    local item_11 = GUI:getChildByName(List, "item_11")
    if not item_11 then
        item_11 = GUI:Layout_Create(List, "item_11", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_11, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 手持负重
    local minHW = SL:GetMetaValue("T.M.HW")
    local maxHW = SL:GetMetaValue("T.M.MAXHW")
    local item_12 = GUI:getChildByName(List, "item_12")
    if not item_12 then
        item_12 = GUI:Layout_Create(List, "item_12", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_12, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
    ...
    -- 掉落概率
    local dp = SL:GetMetaValue("T.M.DROP")
    local item_13 = GUI:getChildByName(List, "item_13")
    if not item_13 then
        item_13 = GUI:Layout_Create(List, "item_13", 0, 0, TradePlayerExtraAtt.attachW  - 10, 30, true)
        local num_bg = GUI:Image_Create(item_13, "num_bg", 175, 15, TradePlayerExtraAtt.ResPath.."1900015004.png")
        GUI:setContentSize(num_bg, {width = 110, height = 26})
        GUI:Image_setScale9Slice(num_bg, 30, 30, 6, 6)
        GUI:setAnchorPoint(num_bg, 0, 0.5)
