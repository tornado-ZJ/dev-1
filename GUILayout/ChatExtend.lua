...
function ChatExtend.main()
    ...
    -- 快捷命令
    local btnQuick = GUI:Button_Create(btnGroups, "btnQuick", 74.2, 30, "res/private/chat/1900012861.png")
    GUI:Button_loadTexturePressed(btnQuick, "res/private/chat/1900012860.png")
    GUI:setAnchorPoint(btnQuick, 0.5, 0.5)

    -- 表情
    local btnEmoji = GUI:Button_Create(btnGroups, "btnEmoji", 148.4, 30, "res/private/chat/1900012853.png")
    GUI:Button_loadTexturePressed(btnEmoji, "res/private/chat/1900012852.png")
    GUI:setAnchorPoint(btnEmoji, 0.5, 0.5)

    -- 道具
    local btnItems = GUI:Button_Create(btnGroups, "btnItems", 222.6, 30, "res/private/chat/1900012857.png")
    GUI:Button_loadTexturePressed(btnItems, "res/private/chat/1900012856.png")
    GUI:setAnchorPoint(btnItems, 0.5, 0.5)

    -- 位置
    local btnPosition = GUI:Button_Create(btnGroups, "btnPosition", 296.8, 30, "res/private/chat/1900012859.png")
