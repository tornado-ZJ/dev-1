...
function TradePlayerHeroMain.main( skipPage )
    ...
    GUI:addOnClickEvent(Page6, function()
        TradePlayerHeroMain.PageTo(6)
    end)
    posY = posY - distance
    local PageText6 = GUI:Text_Create(Page6, "PageText", 13, 60, 18, "#ffffff", "神\n装")
    GUI:setAnchorPoint(PageText6, 0.5, 0.5)

    TradePlayerHeroMain.PageTo(skipPage or 1)
end

function TradePlayerHeroMain.PageTo(index)
    TradePlayerHeroMain.index = index
end